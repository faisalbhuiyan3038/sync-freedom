...
declare module '#imports' {
  ...
  export { LockScreen } from '../src/components/LockScreen';
  export { MyTabsPanel, TabRow, EmptyState } from '../src/components/MyTabsPanel';
  export { RemoteTabsPanel } from '../src/components/RemoteTabsPanel';
  export { SettingsPanel } from '../src/components/SettingsPanel';
  export { SetupWizard } from '../src/components/SetupWizard';
  export { TabHistoryPanel } from '../src/components/TabHistoryPanel';
  export { debounce, scheduleAlarmDebounce } from '../src/utils/debounce';
  export { getFaviconUrl, isInternalUrl } from '../src/utils/favicon';
}
